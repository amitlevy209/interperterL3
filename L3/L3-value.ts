...
export type Class = {//___________________________
    tag: "Class";
    fields: VarDecl[];
    methods: Binding[];
    env: Env;
}
export const makeClass = (fields: VarDecl[], methods: Binding[]): Class =>//___________________________
    ({tag: "Class", fields: fields, methods: methods, env: makeEmptyEnv()});

    export const makeClassEnv = (fields: VarDecl[], methods: Binding[], env: Env): Class =>//___________________________
...
export type Object = {//___________________________
    tag: "Object";
    class: Class;
    fields: Value[];
    env: Env;
}
export const makeObject = (c: Class, fields: Value[]): Object =>//___________________________
    ({tag: "Object", class: c, fields: fields ,env: makeEmptyEnv()});
export const makeObjectEnv = (c: Class, fields: Value[],env: Env): Object =>//___________________________
    ({tag: "Object", class: c, fields: fields ,env: env});
export const isObject = (x: any): x is Object => x.tag === "Object";//___________________________
// ========================================================
// SExp
...
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp| Class|Object;//___________________________
...
export const ClassDToString = (c: Class): string =>{
    const fields = map(b => b, c.fields);
    const methods = map(b => b.var, c.methods);
    return `Class ${fields} ${methods}`
}//___________________________

export const ObjectToString = (val: Object): string =>
...
export const valueToString = (val: Value): string =>
    ...
    isClass(val) ? ClassToString(val) ://___________________________
    isObject(val) ? ObjectToString(val)://___________________________
    val;
